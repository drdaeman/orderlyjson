# $ANTLR 3.1.3 Mar 17, 2009 19:23:44 orderlyjson/OrderlyJSON.g 2012-05-01 04:04:26
...
class OrderlyJSONParser(Parser):
    grammarFileName = "orderlyjson/OrderlyJSON.g"
    ...
    # orderlyjson/OrderlyJSON.g:33:1: orderly_schema returns [result] : (e= unnamed_entries )? ( ';' )? ;
    def orderly_schema(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:33:33: ( (e= unnamed_entries )? ( ';' )? )
                # orderlyjson/OrderlyJSON.g:33:35: (e= unnamed_entries )? ( ';' )?
                pass 
                # orderlyjson/OrderlyJSON.g:33:36: (e= unnamed_entries )?
                alt1 = 2
                ...
                # orderlyjson/OrderlyJSON.g:33:54: ( ';' )?
                alt2 = 2
    ...
    # orderlyjson/OrderlyJSON.g:35:1: named_entries returns [result] : e= named_entry ( ';' e2= named_entry )* ;
    def named_entries(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:38:2: (e= named_entry ( ';' e2= named_entry )* )
                # orderlyjson/OrderlyJSON.g:39:3: e= named_entry ( ';' e2= named_entry )*
                pass 
                self._state.following.append(self.FOLLOW_named_entry_in_named_entries123)
                e = self.named_entry()

                self._state.following.pop()
                # orderlyjson/OrderlyJSON.g:39:17: ( ';' e2= named_entry )*
                while True: #loop3
                    alt3 = 2
                    ...
                    if alt3 == 1:
                        # orderlyjson/OrderlyJSON.g:40:5: ';' e2= named_entry
                        pass 
    ...
    # orderlyjson/OrderlyJSON.g:43:1: unnamed_entries returns [result] : e= unnamed_entry ( ';' e2= unnamed_entry )* ;
    def unnamed_entries(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:46:2: (e= unnamed_entry ( ';' e2= unnamed_entry )* )
                # orderlyjson/OrderlyJSON.g:47:3: e= unnamed_entry ( ';' e2= unnamed_entry )*
                pass 
                self._state.following.append(self.FOLLOW_unnamed_entry_in_unnamed_entries164)
                e = self.unnamed_entry()

                self._state.following.pop()
                # orderlyjson/OrderlyJSON.g:47:19: ( ';' e2= unnamed_entry )*
                while True: #loop4
                    alt4 = 2
                    ...
                    if alt4 == 1:
                        # orderlyjson/OrderlyJSON.g:48:6: ';' e2= unnamed_entry
                        pass 
    ...
    # orderlyjson/OrderlyJSON.g:51:1: named_entry returns [result] : ( (pref= definition_prefix name= property_name suff= definition_suffix ) | (pref= string_prefix name= property_name suff= string_suffix ) );
    def named_entry(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:52:3: ( (pref= definition_prefix name= property_name suff= definition_suffix ) | (pref= string_prefix name= property_name suff= string_suffix ) )
                alt5 = 2
                ...
                if alt5 == 1:
                    # orderlyjson/OrderlyJSON.g:52:6: (pref= definition_prefix name= property_name suff= definition_suffix )
                    pass 
                    # orderlyjson/OrderlyJSON.g:52:6: (pref= definition_prefix name= property_name suff= definition_suffix )
                    # orderlyjson/OrderlyJSON.g:52:7: pref= definition_prefix name= property_name suff= definition_suffix
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:53:6: (pref= string_prefix name= property_name suff= string_suffix )
                    pass 
                    # orderlyjson/OrderlyJSON.g:53:6: (pref= string_prefix name= property_name suff= string_suffix )
                    # orderlyjson/OrderlyJSON.g:53:7: pref= string_prefix name= property_name suff= string_suffix
                    pass 
    ...
    # orderlyjson/OrderlyJSON.g:56:1: unnamed_entry returns [result] : (pref= definition_prefix suff= definition_suffix | pref= string_prefix suff= string_suffix );
    def unnamed_entry(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:57:3: (pref= definition_prefix suff= definition_suffix | pref= string_prefix suff= string_suffix )
                alt6 = 2
                ...
                if alt6 == 1:
                    # orderlyjson/OrderlyJSON.g:57:6: pref= definition_prefix suff= definition_suffix
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:58:6: pref= string_prefix suff= string_suffix
                    pass 
    ...
    # orderlyjson/OrderlyJSON.g:61:1: definition_prefix returns [result] : ( 'integer' (rng= optional_range )? | 'number' (rng= optional_range )? | 'boolean' | 'null' | 'any' | 'array' ( ( '{' (e= unnamed_entries )? ( ';' )? '}' (o= OPTIONAL_ADDITIONAL_MARKER )? (rng= optional_range )? ) | ( '[' (e= unnamed_entry )? ( ';' )? ']' (rng= optional_range )? ) ) | 'object' '{' (e= named_entries )? ( ';' )? '}' (o= OPTIONAL_ADDITIONAL_MARKER )? | 'union' '{' (e= unnamed_entries )? ( ';' )? '}' );
    def definition_prefix(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:62:3: ( 'integer' (rng= optional_range )? | 'number' (rng= optional_range )? | 'boolean' | 'null' | 'any' | 'array' ( ( '{' (e= unnamed_entries )? ( ';' )? '}' (o= OPTIONAL_ADDITIONAL_MARKER )? (rng= optional_range )? ) | ( '[' (e= unnamed_entry )? ( ';' )? ']' (rng= optional_range )? ) ) | 'object' '{' (e= named_entries )? ( ';' )? '}' (o= OPTIONAL_ADDITIONAL_MARKER )? | 'union' '{' (e= unnamed_entries )? ( ';' )? '}' )
                alt22 = 8
                ...
                if alt22 == 1:
                    # orderlyjson/OrderlyJSON.g:62:6: 'integer' (rng= optional_range )?
                    pass 
                    self.match(self.input, 18, self.FOLLOW_18_in_definition_prefix313)
                    # orderlyjson/OrderlyJSON.g:62:19: (rng= optional_range )?
                    alt7 = 2
                    ...
                    # orderlyjson/OrderlyJSON.g:63:6: 'number' (rng= optional_range )?
                    pass 
                    self.match(self.input, 19, self.FOLLOW_19_in_definition_prefix386)
                    # orderlyjson/OrderlyJSON.g:63:18: (rng= optional_range )?
                    alt8 = 2
                    ...
                    # orderlyjson/OrderlyJSON.g:64:6: 'boolean'
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:65:6: 'null'
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:66:6: 'any'
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:67:6: 'array' ( ( '{' (e= unnamed_entries )? ( ';' )? '}' (o= OPTIONAL_ADDITIONAL_MARKER )? (rng= optional_range )? ) | ( '[' (e= unnamed_entry )? ( ';' )? ']' (rng= optional_range )? ) )
                    pass 
                    self.match(self.input, 23, self.FOLLOW_23_in_definition_prefix731)
                    # orderlyjson/OrderlyJSON.g:67:14: ( ( '{' (e= unnamed_entries )? ( ';' )? '}' (o= OPTIONAL_ADDITIONAL_MARKER )? (rng= optional_range )? ) | ( '[' (e= unnamed_entry )? ( ';' )? ']' (rng= optional_range )? ) )
                    alt16 = 2
                    ...
                    if alt16 == 1:
                        # orderlyjson/OrderlyJSON.g:68:7: ( '{' (e= unnamed_entries )? ( ';' )? '}' (o= OPTIONAL_ADDITIONAL_MARKER )? (rng= optional_range )? )
                        pass 
                        # orderlyjson/OrderlyJSON.g:68:7: ( '{' (e= unnamed_entries )? ( ';' )? '}' (o= OPTIONAL_ADDITIONAL_MARKER )? (rng= optional_range )? )
                        # orderlyjson/OrderlyJSON.g:68:8: '{' (e= unnamed_entries )? ( ';' )? '}' (o= OPTIONAL_ADDITIONAL_MARKER )? (rng= optional_range )?
                        pass 
                        self.match(self.input, 24, self.FOLLOW_24_in_definition_prefix742)
                        # orderlyjson/OrderlyJSON.g:68:13: (e= unnamed_entries )?
                        alt9 = 2
                        ...
                        # orderlyjson/OrderlyJSON.g:68:31: ( ';' )?
                        alt10 = 2
                        ...
                        # orderlyjson/OrderlyJSON.g:68:41: (o= OPTIONAL_ADDITIONAL_MARKER )?
                        alt11 = 2
                        ...
                        # orderlyjson/OrderlyJSON.g:68:73: (rng= optional_range )?
                        alt12 = 2
                        ...
                        # orderlyjson/OrderlyJSON.g:69:7: ( '[' (e= unnamed_entry )? ( ';' )? ']' (rng= optional_range )? )
                        pass 
                        # orderlyjson/OrderlyJSON.g:69:7: ( '[' (e= unnamed_entry )? ( ';' )? ']' (rng= optional_range )? )
                        # orderlyjson/OrderlyJSON.g:69:8: '[' (e= unnamed_entry )? ( ';' )? ']' (rng= optional_range )?
                        pass 
                        self.match(self.input, 26, self.FOLLOW_26_in_definition_prefix778)
                        # orderlyjson/OrderlyJSON.g:69:13: (e= unnamed_entry )?
                        alt13 = 2
                        ...
                        # orderlyjson/OrderlyJSON.g:69:29: ( ';' )?
                        alt14 = 2
                        ...
                        # orderlyjson/OrderlyJSON.g:69:41: (rng= optional_range )?
                        alt15 = 2
                    ...
                    # orderlyjson/OrderlyJSON.g:70:6: 'object' '{' (e= named_entries )? ( ';' )? '}' (o= OPTIONAL_ADDITIONAL_MARKER )?
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:70:20: (e= named_entries )?
                    alt17 = 2
                    ...
                    # orderlyjson/OrderlyJSON.g:70:36: ( ';' )?
                    alt18 = 2
                    ...
                    # orderlyjson/OrderlyJSON.g:70:46: (o= OPTIONAL_ADDITIONAL_MARKER )?
                    alt19 = 2
                    ...
                    # orderlyjson/OrderlyJSON.g:71:6: 'union' '{' (e= unnamed_entries )? ( ';' )? '}'
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:71:20: (e= unnamed_entries )?
                    alt20 = 2
                    ...
                    # orderlyjson/OrderlyJSON.g:71:38: ( ';' )?
                    alt21 = 2
    ...
    # orderlyjson/OrderlyJSON.g:74:1: string_prefix returns [result] : 'string' (rng= optional_range )? ;
    def string_prefix(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:74:32: ( 'string' (rng= optional_range )? )
                # orderlyjson/OrderlyJSON.g:74:35: 'string' (rng= optional_range )?
                pass 
                self.match(self.input, 30, self.FOLLOW_30_in_string_prefix969)
                # orderlyjson/OrderlyJSON.g:74:47: (rng= optional_range )?
                alt23 = 2
    ...
    # orderlyjson/OrderlyJSON.g:76:1: string_suffix returns [result] : (regex= OPTIONAL_PERL_REGEX )? suff= definition_suffix ;
    def string_suffix(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:76:32: ( (regex= OPTIONAL_PERL_REGEX )? suff= definition_suffix )
                # orderlyjson/OrderlyJSON.g:76:35: (regex= OPTIONAL_PERL_REGEX )? suff= definition_suffix
                pass 
                # orderlyjson/OrderlyJSON.g:76:40: (regex= OPTIONAL_PERL_REGEX )?
                alt24 = 2
    ...
    # orderlyjson/OrderlyJSON.g:78:1: definition_suffix returns [result] : (enums= optional_enum_values )? (d= optional_default_value )? (requires= optional_requires )? (optional= OPTIONAL_OPTIONAL_MARKER )? (extra= optional_extra_properties )? ;
    def definition_suffix(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:78:35: ( (enums= optional_enum_values )? (d= optional_default_value )? (requires= optional_requires )? (optional= OPTIONAL_OPTIONAL_MARKER )? (extra= optional_extra_properties )? )
                # orderlyjson/OrderlyJSON.g:79:2: (enums= optional_enum_values )? (d= optional_default_value )? (requires= optional_requires )? (optional= OPTIONAL_OPTIONAL_MARKER )? (extra= optional_extra_properties )?
                pass 
                # orderlyjson/OrderlyJSON.g:79:7: (enums= optional_enum_values )?
                alt25 = 2
                ...
                # orderlyjson/OrderlyJSON.g:80:3: (d= optional_default_value )?
                alt26 = 2
                ...
                # orderlyjson/OrderlyJSON.g:81:10: (requires= optional_requires )?
                alt27 = 2
                ...
                # orderlyjson/OrderlyJSON.g:82:10: (optional= OPTIONAL_OPTIONAL_MARKER )?
                alt28 = 2
                ...
                # orderlyjson/OrderlyJSON.g:83:7: (extra= optional_extra_properties )?
                alt29 = 2
    ...
    # orderlyjson/OrderlyJSON.g:92:1: csv_property_names returns [result] : prop= property_name ( ',' prop2= property_name )* ;
    def csv_property_names(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:95:3: (prop= property_name ( ',' prop2= property_name )* )
                # orderlyjson/OrderlyJSON.g:96:5: prop= property_name ( ',' prop2= property_name )*
                pass 
                self._state.following.append(self.FOLLOW_property_name_in_csv_property_names1062)
                prop = self.property_name()

                self._state.following.pop()
                # orderlyjson/OrderlyJSON.g:96:24: ( ',' prop2= property_name )*
                while True: #loop30
                    alt30 = 2
                    ...
                    if alt30 == 1:
                        # orderlyjson/OrderlyJSON.g:97:7: ',' prop2= property_name
                        pass 
    ...
    # orderlyjson/OrderlyJSON.g:100:1: optional_extra_properties returns [result] : ( '`' obj= json_object '`' ) ;
    def optional_extra_properties(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:100:45: ( ( '`' obj= json_object '`' ) )
                # orderlyjson/OrderlyJSON.g:100:48: ( '`' obj= json_object '`' )
                pass 
                # orderlyjson/OrderlyJSON.g:100:48: ( '`' obj= json_object '`' )
                # orderlyjson/OrderlyJSON.g:100:49: '`' obj= json_object '`'
                pass 
    ...
    # orderlyjson/OrderlyJSON.g:102:1: optional_requires returns [result] : ( '<' p= csv_property_names '>' ) ;
    def optional_requires(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:102:37: ( ( '<' p= csv_property_names '>' ) )
                # orderlyjson/OrderlyJSON.g:102:40: ( '<' p= csv_property_names '>' )
                pass 
                # orderlyjson/OrderlyJSON.g:102:40: ( '<' p= csv_property_names '>' )
                # orderlyjson/OrderlyJSON.g:102:41: '<' p= csv_property_names '>'
                pass 
    ...
    # orderlyjson/OrderlyJSON.g:108:1: optional_enum_values returns [result] : arr= json_array ;
    def optional_enum_values(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:108:39: (arr= json_array )
                # orderlyjson/OrderlyJSON.g:108:41: arr= json_array
                pass 
    ...
    # orderlyjson/OrderlyJSON.g:110:1: optional_default_value returns [result] : ( '=' d= json_value ) ;
    def optional_default_value(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:110:41: ( ( '=' d= json_value ) )
                # orderlyjson/OrderlyJSON.g:110:43: ( '=' d= json_value )
                pass 
                # orderlyjson/OrderlyJSON.g:110:43: ( '=' d= json_value )
                # orderlyjson/OrderlyJSON.g:110:44: '=' d= json_value
                pass 
    ...
    # orderlyjson/OrderlyJSON.g:112:1: optional_range returns [out] : '{' (s= json_number )? ',' (e= json_number )? '}' ;
    def optional_range(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:112:30: ( '{' (s= json_number )? ',' (e= json_number )? '}' )
                # orderlyjson/OrderlyJSON.g:112:32: '{' (s= json_number )? ',' (e= json_number )? '}'
                pass 
                self.match(self.input, 24, self.FOLLOW_24_in_optional_range1212)
                # orderlyjson/OrderlyJSON.g:112:37: (s= json_number )?
                alt31 = 2
                ...
                # orderlyjson/OrderlyJSON.g:112:56: (e= json_number )?
                alt32 = 2
    ...
    # orderlyjson/OrderlyJSON.g:114:1: property_name returns [result] : (s= json_string | r= PROPERTY_NAME_TOKEN );
    def property_name(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:115:3: (s= json_string | r= PROPERTY_NAME_TOKEN )
                alt33 = 2
                ...
                if alt33 == 1:
                    # orderlyjson/OrderlyJSON.g:115:5: s= json_string
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:116:5: r= PROPERTY_NAME_TOKEN
                    pass 
    ...
    # orderlyjson/OrderlyJSON.g:125:1: json_object returns [result] : '{' (m= members )? '}' ;
    def json_object(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:125:30: ( '{' (m= members )? '}' )
                # orderlyjson/OrderlyJSON.g:125:33: '{' (m= members )? '}'
                pass 
                self.match(self.input, 24, self.FOLLOW_24_in_json_object1380)
                # orderlyjson/OrderlyJSON.g:125:38: (m= members )?
                alt34 = 2
    ...
    # $ANTLR start "members"
    # orderlyjson/OrderlyJSON.g:127:1: members returns [d] : p1= pair ( ',' p2= pair )* ;
    def members(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:131:1: (p1= pair ( ',' p2= pair )* )
                # orderlyjson/OrderlyJSON.g:131:4: p1= pair ( ',' p2= pair )*
                pass 
                self._state.following.append(self.FOLLOW_pair_in_members1410)
                p1 = self.pair()

                self._state.following.pop()
                # orderlyjson/OrderlyJSON.g:131:12: ( ',' p2= pair )*
                while True: #loop35
                    alt35 = 2
                    ...
                    if alt35 == 1:
                        # orderlyjson/OrderlyJSON.g:132:3: ',' p2= pair
                        pass 
    ...
    # $ANTLR start "pair"
    # orderlyjson/OrderlyJSON.g:135:1: pair returns [out] : k= json_string ':' v= json_value ;
    def pair(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:135:20: (k= json_string ':' v= json_value )
                # orderlyjson/OrderlyJSON.g:135:23: k= json_string ':' v= json_value
                pass 
    ...
    # orderlyjson/OrderlyJSON.g:137:1: json_array returns [result] : '[' (elem= elements )? ']' ;
    def json_array(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:137:29: ( '[' (elem= elements )? ']' )
                # orderlyjson/OrderlyJSON.g:137:31: '[' (elem= elements )? ']'
                pass 
                self.match(self.input, 26, self.FOLLOW_26_in_json_array1465)
                # orderlyjson/OrderlyJSON.g:137:39: (elem= elements )?
                alt36 = 2
    ...
    # orderlyjson/OrderlyJSON.g:139:1: json_number returns [result] : i= INTEGER (f= FRAC )? (e= EXP )? ;
    def json_number(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:140:3: (i= INTEGER (f= FRAC )? (e= EXP )? )
                # orderlyjson/OrderlyJSON.g:140:6: i= INTEGER (f= FRAC )? (e= EXP )?
                pass 
                i=self.match(self.input, INTEGER, self.FOLLOW_INTEGER_in_json_number1491)
                # orderlyjson/OrderlyJSON.g:140:17: (f= FRAC )?
                alt37 = 2
                ...
                # orderlyjson/OrderlyJSON.g:140:25: (e= EXP )?
                alt38 = 2
    ...
    # orderlyjson/OrderlyJSON.g:145:1: elements returns [array] : v= json_value ( ',' v2= json_value )* ;
    def elements(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:148:3: (v= json_value ( ',' v2= json_value )* )
                # orderlyjson/OrderlyJSON.g:148:5: v= json_value ( ',' v2= json_value )*
                pass 
                self._state.following.append(self.FOLLOW_json_value_in_elements1522)
                v = self.json_value()

                self._state.following.pop()
                # orderlyjson/OrderlyJSON.g:148:18: ( ',' v2= json_value )*
                while True: #loop39
                    alt39 = 2
                    ...
                    if alt39 == 1:
                        # orderlyjson/OrderlyJSON.g:149:3: ',' v2= json_value
                        pass 
    ...
    # orderlyjson/OrderlyJSON.g:152:1: json_value returns [result] : (val= json_string | val= json_number | val= json_object | val= json_array | 'true' | 'false' | 'null' );
    def json_value(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:153:3: (val= json_string | val= json_number | val= json_object | val= json_array | 'true' | 'false' | 'null' )
                alt40 = 7
                ...
                if alt40 == 1:
                    # orderlyjson/OrderlyJSON.g:153:6: val= json_string
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:154:6: val= json_number
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:155:6: val= json_object
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:156:6: val= json_array
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:157:6: 'true'
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:158:6: 'false'
                    pass 
                    ...
                    # orderlyjson/OrderlyJSON.g:159:6: 'null'
                    pass 
    ...
    # orderlyjson/OrderlyJSON.g:164:1: json_string returns [result] : c= STRING ;
    def json_string(self, ):
        ...
        try:
            try:
                # orderlyjson/OrderlyJSON.g:164:30: (c= STRING )
                # orderlyjson/OrderlyJSON.g:164:32: c= STRING
                pass 
